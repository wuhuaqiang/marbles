Task = {
    ...
    getcurrTasks: (userIds) => {
        ...
        $.ajax({
            type: "post",
            url: BaseUrl+"/api/tTask/currTaskList",
            data: userIds,
            async: false,
            dataType: "json",
    ...
    getcurrTaskByUserId: (userId) => {
        ...
        $.ajax({
            type: "post",
            url: BaseUrl+"/api/tTask/currTaskByOwerId",
            data: userId,
            async: false,
            dataType: "json",
            contentType: 'application/json;charset=UTF-8', //contentType很重要
    ...
    saveTasks: (userId, tasks) => {
        $.ajax({
            type: "post",
            url: BaseUrl+"/api/tTask/lastTaskByOwerId",
            data: userId,
            dataType: "json",
            contentType: 'application/json;charset=UTF-8', //contentType很重要
            success: function (data) {
