...
$(document).on('click','#saveData', () => {
    var lines=$('#myModal .modal-body .input-group');
    console.log(lines);
   ...
   /* const lineArrStr = JSON.stringify(linesArr);
    console.log(lineArrStr)*/
...
function createLine(num){
    ...
    var divStr = "<div class=\"input-group\" index='"+index+"'></div>";
...
function createCdz(){
    ...
    var lag2Str = "<input id='cdz"+index+"' type=\"text\" class=\"form-control startPoint mapSelectPoint\" placeholder=\"位置\">";
    var lag3Str = "<input id='cdzVal"+index+"' type=\"hidden\" class=\"form-control startPointVal mapSelectPoint\" placeholder=\"起点\">";
    var lag4Str = "<span class=\"input-group-addon fix-border fix-padding\"></span>";
    var lag8Str = "<select data-placeholder='选择运行状态...' class='chosen-select form-control' tabindex='2' <option value=''></option> <option value='1'>正常</option> <option value='0'>停运</option> </select>";
    var lag9Str = "<span class=\"input-group-addon fix-border fix-padding\"></span>";
    var lag10Str = "<input id='time"+index+"' type=\"text\" class=\"form-control endTime form-time\" placeholder=\"投运时间：yyyy-MM-dd\">"; //readonly="readonly"
    /* var lag11Str = "<span class=\"input-group-addon fix-border fix-padding\"></span>";*/
    ...
    $divStr.append($lag1Str).append($lag2Str).append($lag3Str).append($lag4Str)
        .append($lag8Str).append($lag9Str).append($lag10Str)
