...
function build_a_tx(data, pos,fromName) {
	var html = '';
	var username = '-';
	var company = '-';
	var id = '-';
	...
	if (!fromName) {
        html += `<div class="txDetails">
				<div class="txCount">创建 </div>
				<p>
					<div class="marbleLegend">交易ID: </div>
					<div class="marbleName txId">` + data.txId.substring(0, 14) + `...</div>
				</p>
				<p>
					<div class="marbleLegend">电量拥有者: </div>
					<div class="marbleName">` + username + `</div>
				</p>
				<p>
					<div class="marbleLegend">所属公司: </div>
				...
				<p>
					<div class="marbleLegend">电量来源: </div>
					<div class="marbleName">` + username + `</div>
				</p>
			</div>`;
	} else {
        html += `<div class="txDetails">
				<div class="txCount">交易 ` + Number(pos)  + `</div>
				<p>
					<div class="marbleLegend">交易ID: </div>
					<div class="marbleName txId">` + data.txId.substring(0, 14) + `...</div>
				</p>
				...
				<p>
					<div class="marbleLegend">电量来源: </div>
					<div class="marbleName">` + fromName + `</div>
				</p>
			</div>`;
	}
	return html;
