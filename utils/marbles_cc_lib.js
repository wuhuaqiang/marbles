...
module.exports = function (enrollObj, g_options, fcw, logger) {
    ...
    //transfer_accounts
    marbles_chaincode.transfer_accounts = function (options, cb) {
        console.log('');
        logger.info('Creating a transfer_accounts...');
    ...
    //queryAccount
    marbles_chaincode.query_account = function (options, cb) {
        console.log('');
        logger.info('Creating a account...');
